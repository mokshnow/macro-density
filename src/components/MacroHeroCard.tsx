  ...
  return (
    <div className="bg-white rounded-2xl border-2 border-gray-300 shadow-sm p-5 sm:p-6 mb-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 py-5">
        ...
        {/* 6. Consensus (Replaced Traded Volume) */}
        <div className="bg-white p-3.5 rounded-xl border-2 border-gray-300 shadow-2xs">
          <div className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1">
            Consensus
          </div>
      ...
      <div className="pt-4 border-t border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs">
        <div className="flex items-start gap-2.5 text-gray-800 bg-gray-50/80 p-3.5 rounded-xl border-2 border-gray-200/90 w-full">
