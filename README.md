...
- **Styling**: Tailwind CSS + Custom Augustus Design System (Hairline borders, subtle grids, typography)
- **Visualizations**: Interactive SVG Density Engine (Smooth PDF Spline, PMF Bins, CDF Step, Black-Scholes normal overlay)
- **Exports**: 1-click CSV, structured JSON, formatted Markdown tables, and ready-to-run Python/Pandas scripts.
- **Reporting**: Print-ready Institutional PDF memo preview.
